                                        ...
                                        <div class="product-quantity">
                                            <div class="num-block skin-2">
                                                ...
                                                <?php
                                                  ...
                                                  ?>
                                                    <a href="<?= base_url('keranjang/updateKurang/') . encrypt_url($row['id_penjualan_detail']); ?> ?>." <?= "style='display: " . $display . "'" ?> class="minus dis"></a>
                                                  
                                                    <label for="quan-1" class="visually-hidden"></label>
                                                    <input id="quantity_<?= $i ?>" name="jumlah" type="number" min="1" value="<?= $row['jumlah'] ?>" readonly="">
                                                    <a href="<?= base_url('keranjang/updateTambah/') . encrypt_url($row['id_penjualan_detail']); ?> ?>." class="plus" ></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
